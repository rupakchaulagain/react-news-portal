...
module.exports = function (t, a) {
	...
	a(t(x, y), true, "Object: Infinite Recursion: Same hashh1");

	x.rec.foo = y;
	a(t(x, y), true, "Object: Infinite Recursion: Same hashh2");

	x.rec.foo = x;
	y.rec.foo = y;
	a(t(x, y), true, "Object: Infinite Recursion: Same hashh3");
